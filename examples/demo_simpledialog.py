...
def main():
    ...
    def tk_askstring():
        ...
        result = tk_simpledialog.askstring(
    ...
    def tk_askfloat():
        ...
        result = tk_simpledialog.askfloat(
            "Input",
            "Enter your height (m):",
            parent=root,
            minvalue=0.0,
    ...
    tkface.Button(left_frame, text="askinteger", command=tk_askinteger).pack(
        pady=3, fill=tk.X
    )
    tkface.Button(left_frame, text="askfloat", command=tk_askfloat).pack(
        pady=3, fill=tk.X
    )
    ...
    def tkface_askstring_en():
        ...
        result = tkface_simpledialog.askstring(
            message="Enter your name:", title="Input", language="en"
        )
        print(f"Result: {result}")

    def tkface_askinteger_en():
        print("=== tkface.simpledialog.askinteger (English) ===")
        result = tkface_simpledialog.askinteger(
    ...
    def tkface_askfloat_en():
        ...
        result = tkface_simpledialog.askfloat(
    ...
    def tkface_askfromlistbox_multiple_en():
        print(
            "=== tkface.simpledialog.askfromlistbox (multiple selection) ==="
        )
        result = tkface_simpledialog.askfromlistbox(
    ...
    tkface.Button(
        center_frame, text="askstring (EN)", command=tkface_askstring_en
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        center_frame, text="askinteger (EN)", command=tkface_askinteger_en
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        center_frame, text="askfloat (EN)", command=tkface_askfloat_en
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        center_frame,
        text="askfromlistbox single (EN)",
        command=tkface_askfromlistbox_single_en,
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        center_frame,
        text="askfromlistbox multiple (EN)",
        command=tkface_askfromlistbox_multiple_en,
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        center_frame,
    ...
    tkface.Button(
        right_frame, text="askstring (JA)", command=tkface_askstring_ja
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        right_frame, text="askinteger (JA)", command=tkface_askinteger_ja
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        right_frame, text="askfloat (JA)", command=tkface_askfloat_ja
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        right_frame,
        text="askfromlistbox single (JA)",
        command=tkface_askfromlistbox_single_ja,
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        right_frame,
        text="askfromlistbox multiple (JA)",
        command=tkface_askfromlistbox_multiple_ja,
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        right_frame,
    ...
    tkface.Button(
        right_frame, text="custom offset (JA)", command=tkface_custom_offset_ja
    ).pack(pady=3, fill=tk.X)
    tkface.Button(
        right_frame,
        text="custom translations",
        command=tkface_custom_translations,
    ).pack(pady=3, fill=tk.X)
    # Footer
