...
def main():
    ...
    def tk_showerror():
        ...
        result = tk_messagebox.showerror("Error", "An error has occurred.", parent=root)
        print(f"Result: {result}")

    def tk_showinfo():
        print("=== tkinter.messagebox.showinfo ===")
        result = tk_messagebox.showinfo("Info", "Operation completed successfully.", parent=root)
        print(f"Result: {result}")

    def tk_showwarning():
        print("=== tkinter.messagebox.showwarning ===")
        result = tk_messagebox.showwarning("Warning", "This is a warning message.", parent=root)
        print(f"Result: {result}")

    def tk_askquestion():
        print("=== tkinter.messagebox.askquestion ===")
        result = tk_messagebox.askquestion("Question", "Do you want to proceed?", parent=root)
        print(f"Result: {result}")

    def tk_askyesno():
        print("=== tkinter.messagebox.askyesno ===")
        result = tk_messagebox.askyesno("Question", "Do you want to proceed?", parent=root)
        print(f"Result: {result}")
    ...
    tk.Label(center_frame, text="tkface.messagebox\n(English)", font=("Arial", 12, "bold")).pack(pady=(0, 10))
    ...
    def tkface_askyesno_en():
        ...
        result = tkface_messagebox.askyesno(message="Do you want to proceed?", language="en")
        print(f"Result: {result}")
    ...
    def tkface_custom_position_en():
        ...
        x = int(100 * scaling)
        y = int(100 * scaling)
        result = tkface_messagebox.showinfo(message="This box appears at a custom position.", x=x, y=y, language="en")
        print(f"Result: {result}")
    ...
    tk.Label(right_frame, text="tkface.messagebox\n(Japanese)", font=("Arial", 12, "bold")).pack(pady=(0, 10))
    ...
    def tkface_askyesno_ja():
        ...
        result = tkface_messagebox.askyesno(message="Do you want to proceed?", language="ja")
        print(f"Result: {result}")
    ...
    def tkface_custom_position_ja():
        ...
        x = int(100 * scaling)
        y = int(100 * scaling)
        result = tkface_messagebox.showinfo(message="This box appears at a custom position.", x=x, y=y, language="ja")
        print(f"Result: {result}")
    ...
    footer_text = "Click buttons to test message boxes. Check console for results."
